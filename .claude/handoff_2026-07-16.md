...
- `codex/robustness`: current branch, stacked on `codex/feature-gaps`. Phase 2
  task/log checkpoint is `07d92b6`; Phase 2-1 and Phase 2-2 are now qualified
  and adopted into nightly/manual fuzz CI as documented in
...
The next planned Phase 2-3 task is encoder adversarial-input and setter-sequence
fuzzing, including non-finite float PCM.
