...
func TestCGORef(t *testing.T) {
	...
	cases := []vecCase{
		{1, 2, 48000, 1413}, {2, 2, 48000, 0}, {3, 2, 48000, 0}, {4, 2, 48000, 0},
		{5, 2, 48000, 0}, {6, 2, 48000, 0}, {7, 2, 48000, 0}, {8, 2, 48000, 402},
		{9, 2, 48000, 367}, {10, 2, 48000, 1164}, {11, 2, 48000, 349}, {12, 2, 48000, 12},
	}
